...
import overFlow.Objects.PrefBtn;
...
final public class OverFlowMain {
	...
	public static Vector<Connection> currentSelectedConnections = new Vector();
	public static Vector<Node> currentSelectedObjects = new Vector();
	public static Vector<Connection> connections = new Vector();
	public static Vector<Node> objects = new Vector();
